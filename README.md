...
6. How is the company meeting its monthly targets?
## Data Collection
I was given a **folder of raw csv files** with over 50,000 records spanning the period from 2020 to 2022. The data includes attributes such as **dim_customers**, **dim_products**, **dim_calendar**, **dim_territory**, **facts_sales_data**, and **facts_returns_data** The **csv** data was then extract from the folder, into power query where it was cleaned and transformed.
